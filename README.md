...
The easiest way to get started is to clone this repo and run `npm start`. The demo song will be running at [http://localhost:3000](http://localhost:3000). You can open up the `/app/index.js` file and edit your song there, using the API below as reference.
