...
sounds.append(pg.mixer.Sound(pg.mixer.Sound("/Users/ianborukhovich/Projects/curiosity_driven_data_mining/genetic_beats/G.wav")))
sounds.append(pg.mixer.Sound(pg.mixer.Sound("/Users/ianborukhovich/Projects/curiosity_driven_data_mining/genetic_beats/C.wav")))
sounds.append(pg.mixer.Sound(pg.mixer.Sound("/Users/ianborukhovich/Projects/curiosity_driven_data_mining/genetic_beats/Eb.wav")))
sounds.append(pg.mixer.Sound(pg.mixer.Sound("/Users/ianborukhovich/Projects/curiosity_driven_data_mining/genetic_beats/F#.wav")))
sounds.append(pg.mixer.Sound(pg.mixer.Sound("/Users/ianborukhovich/Projects/curiosity_driven_data_mining/genetic_beats/D.wav")))
...
def get_inherited_beat(father_beat,father_fitness,mother_beat, mother_fitness):
    ...
    if numpy.random.randint(0,101) > 100*(percent_difference + 50):
...
def identify_fit_progeny(last_generation):
    ...
    return [last_generation[i] for i in saved_progeny_indices], last_generation_fitness
